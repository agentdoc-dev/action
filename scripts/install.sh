...
fail_install() {
  adoc_fail install action.install_failed "$1" 'Use AgentDoc v0.3.3 or newer with a published binary and checksum.'
...
[ "$lowest" = 0.3.3 ] || fail_install "AgentDoc ${resolved} is older than the required v0.3.3"
